...
import { View, Image, ActivityIndicator,Dimensions, Modal, SafeAreaView,Pressable,StyleSheet, Animated, Platform, TouchableOpacity, ImageSourcePropType } from 'react-native'
...
export const ImageSlider = ({
    ...
    return (
        <View>
            ...
            />
            <View style={{ flex: 1, position: 'absolute', bottom: -5, alignSelf: 'center' }}>
                {showIndicator &&
                    <Indicator
                        data={data}
