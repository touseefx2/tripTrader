  ...
  render() {
              ...
              return (
                <Animated.Text
                  style={[
                    ...
                    labelStyle,
                    { color,  fontFamily: theme.fonts.fontBold,textTransform:"capitalize",  fontSize: 14, },
                  ]}
                >
                  {labelText}
                </Animated.Text>
    ...
    if (renderLabel) {
      ...
      const inactiveLabel = renderLabel({
        route,
        focused: false,
        color:theme.color.inactiveTabText,
    ...
    return (
      ...
      >
        <View pointerEvents="none" style={[styles.item, tabStyle,{   backgroundColor: isFocused? theme.color.button1:'transparent'}]}>
          {icon}
          {label}
